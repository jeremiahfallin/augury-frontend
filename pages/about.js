export default function AboutPage() {
  return (
    <section>
      ...
      <p>
        The goal of the game is for every set of matches (where the matches are
        grouped by the day or week they are played on in the season), pick a
        team from one of the matches that you think is going to win.
      </p>
      <p>
